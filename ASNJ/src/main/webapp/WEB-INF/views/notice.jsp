						...
						<c:when test="${empty loginMember}">
							<div class="collapse navbar-collapse" id="navbarCollapse">
								<div class="navbar-nav ms-auto py-0">
									...
									<a href="${cpath}/Notice.do?num=1"
										class="nav-item nav-link active">커뮤니티</a>
								</div>
							</div>
						</c:when>
						<c:otherwise>
							<div class="collapse navbar-collapse" id="navbarCollapse">
								<div class="navbar-nav ms-auto py-0">
									...
									<a href="${cpath}/Diary.do" class="nav-item nav-link">농업일지</a>
									<a href="${cpath}/Notice.do?num=1"
										class="nav-item nav-link active">커뮤니티</a> <a
										href="${cpath}/Mypage.do?mem_pk=${loginMember.mem_pk}"
		...
		<div class="container-fluid pt-4 px-4">
			...
			<div class="tab-content">
				<div class="container tab-pane fade" id="info">
					<!-- 공지사항 시작 -->
					<div class="container"
						style="width: 100%; height: auto; border-radius: 1em; margin-top: 5px;">
						<br>
										...
										<form action="${cpath}/AnswerInsert.do" method="post">
											...
											<c:forEach items="${questionlist}" var="list" end="0">
												<div class="input-group mb-3">
													<span class="input-group-text" style="font-size: 25px">문의사항 [ ${list.ques_title} ]</span>
												</div>
									...
									<div class="modal-dialog modal-lg modal-dialog-centered">
										<div class="modal-content">
											<div class="modal-header">
												...
												<button type="button" class="btn-close"
													onClick="close_pop();" data-bs-dismiss="modal"></button>
											</div>
											...
											<div class="modal-body">
												...
												<br>
												<div class="modal-footer">
													<span class="text-center mb-0">비회원이십니까? <a
														href="${cpath}/Joinpage.do">회원가입</a>
													</span> &nbsp;&nbsp;&nbsp; <span class="text-center mb-0">로그인
														하시겠습니까? <a href="${cpath}/Loginpage.do">로그인</a>
													</span>
												</div>
											</div>
										</div>
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<form action="${cpath}/QuestionInsert.do" method="post">
													<input type="hidden" name="mem_pk"
														value="${loginMember.mem_pk}"> <input
														type="hidden" name="ques_user_id"
														value="${loginMember.mem_user_id}">
													<div id="dialog-confirm">
														<div class="input-group mb-3">
															<span class="input-group-text">제목</span> <input
																type="text" class="form-control" name="ques_title"
																placeholder="제목을 입력하세요.">
														</div>
														<textarea style="width: 100%;" name="ques_content"
