						...
						<div class="navbar-nav ms-auto py-0">
							...
							<div class="nav-item dropdown">
								...
								<div class="dropdown-menu m-0">
									<a href="${cpath}/Disease.do" class="dropdown-item avtive">병(病) 피해</a>
									<a href="${cpath}/Pests.do" class="dropdown-item">해충 피해</a>
								</div>
							</div>
							<a href="${cpath}/Diary.do" class="nav-item nav-link">농업일지</a> <a
								href="${cpath}/Notice.do" class="nav-item nav-link">커뮤니케이션</a> <a
								href="${cpath}/Mypage.do" class="nav-item nav-link">마이페이지</a>
						</div>
					</div>
				</nav>
			</div>
