...
<body>
	...
	<div class="container-fluid pt-4 px-4 mx-auto"
		...
		<div>
			<div class="container" style="background-color: rgb(250, 255, 250); width: 80%; height: auto; margin-top: 10px; margin-bottom: 30px; text-align: left;">
				<br>
				<h3 align="center">[YOLO v7을 활용한 병해충 분석 및 정보 서비스입니다.]</h3>
				<br>
				<h5>1. Main 화면: 작물들의(고추, 파, 오이, 딸리, 호박) 방제력을 볼 수 있습니다.</h5>
				<br>
				<h5>2. 병해충 분석 페이지: 병·해충에 걸린 작물의 사진을 업로드 하면 사진을 딥러닝 모델 중 하나인
					YOLO v7으로 분석한 해당 피해 결과 페이지로 이동하여 병해충 정보를 확인 할 수 있습니다.</h5>
				<br>
				<h5>3. 병해충 정보 페이지: 평 피해, 해충 피해 각각 클릭시 해당 페이지의 작물들의 질병에 관련된 정보를 확인 할 수 있습니다.</h5>
				<br>
				<h5>4. 농업일지: 로그인 후 이용이 가능하며 일기장처럼 작뭉들의 상태 및 길이 등의 내용을 적을 수 	있습니다.</h5>
				<br>
				<h5>5. 커뮤니티: 공지사항과 문의사항이 있으며, 문의사항은 로그인 후 이용이 가능합니다.</h5>
				<br>
				<h5>6. 마이페이지: 개인정보 수정 및 탈퇴, 활동내역(북맠, 문의사항 재확인)을 확인 할 수 있습니다.</h5>
				<br>
				<hr>
				<div class="container-xxl p-0" style="display: flex; justify-content: center; align-items: center;">
					<div class="row" style="margin-left: 5%">
						<div class="col-6 col-sm-3">
							...
							<span id="site_st"></span> <br> <span>알쓸농잡</span>
						</div>

						<div class="col-6 col-sm-3">
							<i class="bi bi-hourglass fa-5x" style="margin-right: 80px;"></i>
							<span id="site_st"></span> <br>
							<span id="site_font1">최종프로젝트 일자</span> <br> 
							<span id="site_font1">2022년 12월 13일</span>
						</div>

						<div class="col-6 col-sm-3">
							<i class="bi bi-people-fill fa-5x" style="margin-right: 80px;"></i>
							<span id="site_st"></span> <br>
							<span id="site_font1">팀장: 송영지</span> <br> 
							<span id="site_font1">팀원:김도연,김동현,박승현</span>
						</div>

						<div class="col-6 col-sm-3">
							<i class="bi bi-map fa-5x"></i> <br> 
							<span style="margin-left: 20px;">소재지</span> <br>
							<span id="site_font1">전라남도 순천시 석현동 87 5층,</span> <br> 
							<span id="site_font1">스마트인재개발원 순천점</span> <br> <br>
						</div>
					</div>
				</div>
			</div>
